...
namespace Client.GUI.ViewModel
{
    public class AdminPageViewModel : ViewModelBase
    {
        ...
        //Видимость режимов полей для каждой команды
        [Reactive] public bool IsLoadEmployee { get; set; } = true;
        [Reactive] public bool IsAddEmployee { get; set; }
        [Reactive] public bool IsAccounting { get; set; }
        [Reactive] public bool IsGeneratingReports { get; set; }
        [Reactive] public bool IsChanging { get; set; }
